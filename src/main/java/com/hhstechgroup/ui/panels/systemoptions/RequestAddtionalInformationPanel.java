...
public class RequestAddtionalInformationPanel extends BaseEnrollmentPanel {
    //sp29
    public RequestAddtionalInformationPanel(WebElementFacade panelBaseLocation, AbstractPage basePage) {
    ...
    public String getFirstNotification(){
        return findBy(FIRST_NOTIFICATION).getValue();
    }

    public String getSecondNotification(){
        return findBy(SECOND_NOTIFICATION).getValue();
    }

    public String getThirdNotification(){
        return findBy(THIRD_NOTIFICATION).getValue();
    }
