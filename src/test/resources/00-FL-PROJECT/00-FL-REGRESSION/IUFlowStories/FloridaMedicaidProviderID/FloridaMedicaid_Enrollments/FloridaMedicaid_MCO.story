...
Scenario: Verify Florida Medicaid ID for MCO Enrollment
Meta:
...
When implicit wait '5' seconds
When expand the Group Providers Approval configuration for 'Managed Care Organisation' Enrollment type Page
When implicit wait '5' seconds
