...
Meta:
Given generate firstname, lastname, middlename and email credentials for 'ProviderEnrollmentManager2'
...
When implicit wait '5' seconds
Then rewrite stage of credentials to 'Submitted' for 'ProviderEnrollmentManager2'
