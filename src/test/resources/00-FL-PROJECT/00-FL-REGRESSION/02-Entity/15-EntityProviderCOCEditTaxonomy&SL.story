...
Scenario:Entity Provider edit Taxonomy and SL COC flow to Approve
Meta:
...
Scenario:Verify COC approvals based on System Options Configuration:1 approver,2 reviewers to Edit taxonomy and SL approve COC
Meta:
Given take firstname, lastname and email credentials for type 'Group1' and 'Approved' and use in session
Given user navigated to landing page
