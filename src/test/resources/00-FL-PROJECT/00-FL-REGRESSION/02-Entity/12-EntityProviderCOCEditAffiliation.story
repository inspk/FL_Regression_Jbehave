Scenario:Group Provider Edit Affiliation COC flow to Approve
Meta:
...
Then verify whether 'ENTITY TO TP' provider Affiliation Effective end date '${expDate}' is displayed
When implicit wait '5' seconds
...
When implicit wait '5' seconds
Then verify whether '${businessName}' provider Affiliation Effective end date '${expDate}' is updated
When implicit wait '5' seconds
When log out from IU portal
And implicit wait '5' seconds
When user navigated to landing page
