...
Then Enable the 'Service authorization' Notification in the data change page
Then Enable the 'Provider data' Notification in the data change page
Then Enable the 'PHI' Notification in the data change page
Then Enable the 'PII' Notification in the data change page
Then Enable the 'FTI' Notification in the data change page
When implicit wait '5' seconds
...
Then Disable the 'PHI' Notification in the data change page
Then Disable the 'PII' Notification in the data change page
Then Disable the 'FTI' Notification in the data change page
When implicit wait '5' seconds
Then click on the save button in the data change page
...
Then Enable the 'Service authorization' Corfimation in the data change page
Then Enable the 'Provider data' Corfimation in the data change page
Then Enable the 'PHI' Corfimation in the data change page
Then Enable the 'PII' Corfimation in the data change page
Then Enable the 'FTI' Corfimation in the data change page
When implicit wait '5' seconds
Then click on the save button in the data change page
Then click on 'Edit Button' in the datachange page
...
Then Disable the 'PHI' Corfimation in the data change page
Then Disable the 'PII' Corfimation in the data change page
Then Disable the 'FTI' Corfimation in the data change page
When implicit wait '5' seconds
Then click on the save button in the data change page
