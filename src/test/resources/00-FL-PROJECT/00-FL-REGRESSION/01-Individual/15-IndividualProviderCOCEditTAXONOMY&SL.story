...
Scenario:Individual Provider Edit Taxonomy and SL COC flow to Approve
Meta:
...
And implicit wait '5' seconds
Then Edit taxonomy for '2251H1200X'
...
Then verify whether the updated License No '76A3545' is displayed in Taxonomy Section
When implicit wait '3' seconds
...
Scenario:Verify COC approvals based on System Options Configuration:1 approver,2 reviewers to approve Edit Taxonomy and SL COC
Meta:
Given take firstname, lastname and email credentials for type 'Individual1' and 'Approved' and use in session
Given user navigated to landing page
