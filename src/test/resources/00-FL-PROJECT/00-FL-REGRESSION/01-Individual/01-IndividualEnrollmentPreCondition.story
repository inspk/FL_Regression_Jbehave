...
Scenario: Approvals Reviewers Configuration in Enrollment,COC and Revalidation for Individual Providers
Meta:
...
When verify that 'Reviewer' with 'Gussie Ortiz' is not displayed System Options and add new one with role 'User'
