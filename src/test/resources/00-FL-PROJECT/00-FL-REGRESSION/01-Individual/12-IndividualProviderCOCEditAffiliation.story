...
Scenario:Individual Provider Edit Affiliation COC flow to Approve
Meta:
...
Then verify whether 'ENTITY' provider Affiliation Effective end date '${expDate}' is displayed
When implicit wait '5' seconds
