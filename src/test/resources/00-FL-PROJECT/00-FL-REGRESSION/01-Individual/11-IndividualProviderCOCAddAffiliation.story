...
Scenario:Individual Provider Add Affiliation COC flow to Approve
Meta:
...
And implicit wait '5' seconds
When set npi search value '1972546596' in affiliation section
And implicit wait '5' seconds
...
And refresh page
And implicit wait '5' seconds
When new user logs to Provider Enrollment portal with username - gussie.providers+1450@gmail.com and password - Aa123321!
When click on new 'Agree' button in the Portal page
And implicit wait '5' seconds
