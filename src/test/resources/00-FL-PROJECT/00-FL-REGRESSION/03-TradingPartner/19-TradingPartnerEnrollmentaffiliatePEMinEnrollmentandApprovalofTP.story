...
Meta:
Given generate firstname, lastname, middlename and email credentials for 'TradingPartner4'
...
And implicit wait '5' seconds
When set providerid search value '4000015' in affiliation section
And implicit wait '5' seconds
...
And implicit wait '10' seconds
When user navigated to landing page
When new user logs to Provider Enrollment portal with username - johny.providers+2540@gmail.com and password - Aa123321!
When click on new 'Agree' button in the Portal page
When skip help tour if exists
...
And save value 'CORUS AT HOME LVT' to variable 'businessName'
