...
Then set the internal user inactive days '180'
When implicit wait '2' seconds
Then set the internal user invitation is not acceptable days '30'
When implicit wait '2' seconds
Then set the provider user inactive days '180'
When implicit wait '2' seconds
Then set the provider user invitation is not acceptable days '30'
When implicit wait '2' seconds
