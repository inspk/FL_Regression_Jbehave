...
I can add / edit / remove the service location at the time of revalidation.
...
|Individual1|Male  |10/11/1980|456-76-545111|111-11-1111|222 |Clinic       |Individual Practice|Doctor |Electronic Data Interchange (EDI)|3001 HENDERSON DR      |Landmark         |2222-23433        |22222                   |3534534534|Interpreter     |171R00000X -  Interpreter|5764655900   |License    |California        |100 MAC LANE                 |22110-2345               |22120                           |Non-Profit  |United States |0           |Alabama     |3         |Director             |Managing Non Convicted |

Scenario: Revalidation (did manually)
Meta:
Given take firstname, lastname and email credentials for type 'Individual' and 'Approved' and use in session
Given user navigated to landing page
When new user logs to Provider Enrollment portal with username - ${email} and password - Aa123321!
When skip help tour if exists
And send API request get public providers and find provider data id 'providerDataId' with first name '$firstName' and last name '$lastName'
And get authorization user 'cookies'
When send revalidation request with '${cookies}', providerData '${providerDataId}' and time to revalidation '30d'
And implicit wait '10' seconds
And refresh  page
Then check that revalidation message text is displayed: 'Be informed, your enrollment revalidation is in '
Then check that valid revalidation term 'month' is displayed
...
And To fill the Program Participation section info:
|licenseCertificateType|issuer      |licenseCertificateNumber|effectiveEndDate2|effectiveStartDate2 |
|DEA                   |South Dakota|65432                   |${expDate}       |${date}             |
When implicit wait '5' seconds
When upload document 'Upload License/Certificate Document*' document text_file.txt in Program Participation section
When implicit wait '15' seconds
When click on 'Add' in Program participation section
...
Then save the Program Participation
When implicit wait '3' seconds
Then Edit Program Participation for '152W00000X - Optometrist'
When implicit wait '3' seconds
When click on 'Add Taxonomy' in Program participation section
And To fill the Program Participation section info:
|taxonomy                             |effectiveStartDate|effectiveEndDate|
|152WL0500X - Optometrist - Low Vision|${date}           |${expDate}      |
When implicit wait '3' seconds
When click on 'Add License/Certificate' in Program participation section
And implicit wait '5' seconds
And To fill the Program Participation section info:
|licenseCertificateType|issuer      |licenseCertificateNumber|effectiveEndDate2|effectiveStartDate2 |
|DEA                   |South Dakota|85849                   |${expDate}       |${date}             |
When implicit wait '5' seconds
When upload document 'Upload License/Certificate Document*' document text_file.txt in Program Participation section
When implicit wait '15' seconds
When click on 'Add' in Program participation section
...
Then save the Program Participation
When implicit wait '3' seconds
Then Remove/End Program Participation for '152WL0500X - Optometrist - Low Vision'
When implicit wait '3' seconds
When move to 'Service Location' section
When implicit wait '5' seconds
When click on Add Location in Service Location section
...
When click on 'Save' in Service Location section
When implicit wait '2' seconds
Then Edit Service Location for 'Secondary clinic'
When implicit wait '5' seconds
And To fill the Service Location info:
|patientRecords|personnelRecords|
|Yes|Yes|
When implicit wait '2' seconds
When click on 'Save' in Service Location section
When implicit wait '5' seconds
Then Remove/End Service Location for 'Secondary clinic'
When implicit wait '2' seconds
