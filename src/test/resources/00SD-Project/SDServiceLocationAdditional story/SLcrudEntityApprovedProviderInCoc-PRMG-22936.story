...
while creating CoC, I can delete the primary service location
given by the reason code and select the secondary service location
as primary or add a new primary service location.
...
|Rural Health Clinic   |South Dakota|56789                   |${expDate}       |${date}             |
When implicit wait '5' seconds
...
|Primary clinic|${firstName} |${email}|(111)111-1111|
When implicit wait '5' seconds
When click on 'Save' in Service Location section
When implicit wait '5' seconds
When move to new 'Summary' section
