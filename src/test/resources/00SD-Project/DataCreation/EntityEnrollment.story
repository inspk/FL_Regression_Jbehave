...
When set SSN search value '876-54-3245' in affiliation section
And implicit wait '2' seconds
When set DOB search value '06-03-2000' in affiliation section
And implicit wait '5' seconds
...
When select 'Medicaid/CHIP' with '${date}' and '${expDate}' in affiliation popup
And implicit wait '5' seconds
