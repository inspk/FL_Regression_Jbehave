...
And implicit wait '5' seconds
Then rewrite stage of credentials to 'Submitted' for 'TradingPartner1'
Examples:testdata/CustomSDtradingPartner.table


Scenario:Verify Enrollment approvals based on System Options Configuration:1 approver,2 reviewers to Approve TP Enrollment
Meta:
