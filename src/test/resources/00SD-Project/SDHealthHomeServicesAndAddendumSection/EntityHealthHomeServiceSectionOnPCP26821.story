...
Narrative:
As the DYP Entity Provider,
while creating CoC for Program participation/Taxonomy/License Certificate and Service Location,
system should capture information related to the Health Home Services section
based on the Taxonomy selected.
...
Scenario:Verify that the system is showing Health Home Service section in the form based on the taxonomy selection for Entity Provider
Meta:
