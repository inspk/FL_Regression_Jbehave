...
Scenario:Verify Reconsideration approvals based on System Options Configuration:1 approver,2 reviewers to approve Reconsideration TP Enrollment
Meta:
Given user navigated to landing page
And save value 'CORUS AT HOME LNC' to variable 'businessName'
