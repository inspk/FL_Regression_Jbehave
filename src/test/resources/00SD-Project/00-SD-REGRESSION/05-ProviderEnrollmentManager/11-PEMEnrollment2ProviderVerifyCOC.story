...
Then rewrite stage of credentials to 'ApprovedReviewCOC1' for 'ProviderEnrollmentManager2'
...
When implicit wait '5' seconds
Then rewrite stage of credentials to 'ReviewDeniedCoc2' for 'ProviderEnrollmentManager2'
