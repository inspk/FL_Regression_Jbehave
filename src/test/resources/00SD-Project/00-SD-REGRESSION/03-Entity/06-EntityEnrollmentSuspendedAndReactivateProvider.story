...
And save value 'Medplus Community Service SC' to variable 'providerLegalBusinessName'
...
And select provider reactivation reason 'Expired License' and 'suspended note' Provider Reactivation/Termination popup
And implicit wait '5' seconds
...
And select provider reactivation reason 'Meets Eligibility Criteria' and 'reactivation note' Provider Reactivation/Termination popup
And implicit wait '5' seconds
