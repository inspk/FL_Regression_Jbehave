...
Scenario:Affiliation with PEM for Group Provider Enrollment
Meta:
Given generate firstname, lastname and email credentials for 'Group3'
...
And implicit wait '5' seconds
When select affliation type 'Entity to PEM'
...
When implicit wait '5' seconds
Then rewrite stage of credentials to 'Submitted' for 'Group3'
...
Meta:
Given take firstname, lastname and email credentials for type 'Group3' and 'Submitted' and use in session
Given user navigated to landing page
And save value 'Mediplus Community Service INC' to variable 'providerLegalBusinessName'
...
And implicit wait '10' seconds
Then rewrite stage of credentials to 'Approved' for 'Group3'
