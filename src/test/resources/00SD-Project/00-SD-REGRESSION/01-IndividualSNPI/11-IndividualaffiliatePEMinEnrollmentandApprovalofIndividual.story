...
Scenario:Affiliation with PEM for Individual Provider Enrollment
Meta:
...
And implicit wait '5' seconds
When set providerid search value '4000036' in affiliation section
And implicit wait '5' seconds
...
And implicit wait '10' seconds
When new user logs to Provider Enrollment portal with username - kely.providers+2283@gmail.com and password - Aa123321!
When implicit wait '5' seconds
When click on new 'Agree' button in the Portal page
...
Meta:
Given take firstname, lastname and email credentials for type 'Individual4' and 'Created' and use in session
