...
Narrative:
As the DYP system,
system should mandate for TP affiliation for BNPI individual providers
...
|TPIndividualCocAffiProvider1|10/11/1980|456-76-545111|Doctor|United States |South Dakota|FORT MEADE VAMC|9874563210|60-42484039|Hospital    |633 E SIOUX AVE|Switch Vendor |Director            |Managing Non Convicted|


Scenario:System should mandate for TP affiliation for Individual Provider Enrollment
Meta:
Given generate firstname, lastname and email credentials for '<index>'
And get random npi from file 'WyNPI'
...
|No           |No        |Electronic Data Interchange (EDI)|
And implicit wait '5' seconds
When move to 'Ownership' section
And implicit wait '5' seconds
...
Scenario:Sign Affiliated Individual Provider
Meta:
Given take firstname, lastname and email credentials for type 'TPIndividualCocAffiProvider1' and 'Approved' and use in session
Given user navigated to landing page
When new user logs to Provider Enrollment portal with username - ${email} and password - Aa123321!
When implicit wait '5' seconds
When click on new 'Agree' button in the Portal page
And close informational pop-up if exists
When navigate to Message Center
And implicit wait '5' seconds
When open message in the 'Confirm your affiliation to the individual' message center
When implicit wait '2' seconds
...
Scenario:System should mandate for TP affiliation for Coc Enrollment
Meta:
...
When move to new 'Summary' section
And implicit wait '5' seconds
Then verify popup message as 'Please retain at least one TP affiliation as Claim Submission indicates EDI'
When implicit wait '5' seconds
...
Scenario:System should mandate for TP affiliation for Individual Provider Re-enrollment
Meta:
...
When move to 'Upload Documents' section
When implicit wait '3' seconds
Then verify popup message as 'Please affiliate with a Trading Partner as Claim Submission indicates EDI'
When implicit wait '3' seconds
When move to 'Affiliation' section
And implicit wait '5' seconds
