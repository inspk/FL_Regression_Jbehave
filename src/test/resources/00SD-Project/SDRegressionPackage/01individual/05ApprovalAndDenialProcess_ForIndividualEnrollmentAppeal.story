...
And implicit wait '5' seconds
!-- And fill Appeal application with:
!-- |reason          |firstName|lastName|
!-- |Documents update|William  |Faulkner|
...
Then rewrite stage of credentials to 'CreatedAppeal' for 'Individual2'
...
Then success message with text - Success!Your request was submitted. should be displayed
When implicit wait '5' seconds
Then rewrite stage of credentials to 'CreatedAppeal' for 'Individual3'
