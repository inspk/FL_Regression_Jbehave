...
When implicit wait '5' seconds
Then rewrite stage of credentials to 'CreatedAppeal' for 'ProviderEnrollmentManager2'
...
Then success message with text - Success!Your request was submitted. should be displayed
When implicit wait '5' seconds
Then rewrite stage of credentials to 'CreatedAppeal' for 'ProviderEnrollmentManager3'
