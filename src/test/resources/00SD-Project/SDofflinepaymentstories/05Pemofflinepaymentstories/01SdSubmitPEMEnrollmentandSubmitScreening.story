...
|firstName   |lastName   |gender   |email    |phoneNumber  |fax          |
|${firstName}|${lastName}|${gender}|${email} |(353)453-4534|(477)483-2423|
...
Examples:testdata/PemProvidersForReviewersAndOfflinePayment.table
