...
|softwareName     |versionId|entityCode|
|SD Laser Printer |v3.0     |Kermit    |
And implicit wait '10' seconds
...
Scenario: Approve Coc by 1 approver,2 reviewers to Deny COC TP Enrollment
Meta:
Given take firstname, lastname and email credentials for type 'TradingPartner1' and 'Approved' and use in session
Given save value 'AVERA AT HOME' to variable 'businessName'
Given user navigated to landing page
...
When click on Go to Change of Circumstance button
When wait for screening process execution during '30' seconds
Then rewrite stage of credentials to 'ReviewDeniedCoc' for 'TradingPartner1'

Scenario: Deny Coc by 1 approver,2 reviewers to Deny COC TP Enrollment
Meta:
Given take firstname, lastname and email credentials for type 'TradingPartner1' and 'Approved' and use in session
Given save value 'AVERA AT HOME' to variable 'businessName'
Given user navigated to landing page
