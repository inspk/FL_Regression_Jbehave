...
Then rewrite stage of credentials to 'Appeal' for 'Group2'

Scenario:Deny Group Appeal 2 approvals based on System Options Configuration:1 approver,2 reviewers to Deny Appeal Group Enrollment
Meta:
...
And wait for screening process execution during '5' seconds
Then rewrite stage of credentials to 'Appeal' for 'Group3'