...
Scenario:Register and Enroll the Group Provider Enrollment
Meta:
...
And save value '<email>' to variable 'email'
...
|providerName|federalEmployerIdentification |email    |profitStatus   |
|${firstName}|${fein}                       |${email1}|${profitStatus}|
And To fill the identifying information section for Enrollment:
|dba|
|${dba}|
...
|laboratoryServices|medicareParticipant|medicalDirector|
|No                |No                 |No             |
And To fill the Provider Identification Number:
...
Examples:testdata/demoTestData/GroupinPendingApproval.table
