...
4.Select the Enrollment types for Individual Providers
...
When implicit wait '3' seconds
And turn on CVO reviewers configuration in System Options
When verify that 'COV committee' with 'Elon Mask' is not displayed System Options and also add new one with role 'User'
And set number of CVO reviewers '1' in System Options
