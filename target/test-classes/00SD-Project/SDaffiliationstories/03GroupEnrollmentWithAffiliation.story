...
at the time of enrollment I can add affiliation with individual provider
by selecting the information related to the program participation, specialty, taxonomy and license
...
Scenario:Group Provider Enrollment Flow with Individual Affiliation 'Yes' to 'Do you want to affiliate with Primary service location' in affiliation popup
Meta:
...
Scenario:Group Provider Enrollment Flow with Individual Affiliation 'No' to 'Do you want to affiliate with Primary service location' in affiliation popup
Meta:
Given generate firstname, lastname and email credentials for '<index>'
And get random npi from file 'WyNPI'
And save value '<providerName>' to variable 'providerName'
...
When fill the effective start '${date}' and effective end '${expDate}' to enrollment end affiliation type page
And implicit wait '3' seconds
When click on 'No' to 'Do you want to affiliate with Primary service location' in affiliation popup
And implicit wait '3' seconds
When search for service location data on affiliation popup by next parameters:
|state  |
|Wyoming|
And implicit wait '5' seconds
When add service location with 'Wyoming'
And implicit wait '5' seconds
When fill the location effective start '${date}' and location effective end '${expDate}' in affiliation popup
And implicit wait '3' seconds
When select 'Primary Care Provider (PCP)' with '${date}' and '${expDate}' in affiliation popup
