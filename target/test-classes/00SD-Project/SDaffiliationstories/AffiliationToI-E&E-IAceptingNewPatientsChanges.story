...
Narrative:
As a DYP system,
at the time of Affiliation from Individual to Entity and Entity to Individual,
the system should ask for additional details “Accepting New Patients?”
if the provider selects PCP as Program participation.
...
|207RG0100X - Internal Medicine - Gastroenterology|${date}           |${expDate}      |
And implicit wait '5' seconds
...
And implicit wait '5' seconds
When set type search value 'Group' in affiliation section
And implicit wait '5' seconds
When click search by npi in affiliation section
And implicit wait '5' seconds
When click add button in affiliation section
When select affliation type 'Individual to Group'
...
Scenario: Coc - currently not implemented
Meta:
...
Scenario:Reactivate the Individual Provider
Meta:
Given take firstname, lastname and email credentials for type 'Individual1' and 'Terminated' and use in session
Given user navigated to landing page
And save current date to variable 'date'
...
When set SSN search value '456-76-545111' in affiliation section
And implicit wait '5' seconds
When click search by npi in affiliation section
And implicit wait '5' seconds
When click add button in affiliation section
...
Scenario: Terminate the Entity Provider
Meta:
Given take firstname, lastname and email credentials for type 'Group1' and 'Approved' and use in session
Given save value 'MID DAKOTA PODIATRY' to variable 'providerLegalBusinessName'
Given user navigated to landing page
When new user logs to Internal User portal with username - internal.user.dyp+cd@gmail.com and password - Internaluser1!
And implicit wait '5' seconds
When click on new 'Agree' button in the Portal page
...
Scenario:Reactivate the Entity Provider
Meta:
Given take firstname, lastname and email credentials for type 'Group1' and 'Terminated' and use in session
Given save value 'MID DAKOTA PODIATRY' to variable 'providerLegalBusinessName'
Given user navigated to landing page
