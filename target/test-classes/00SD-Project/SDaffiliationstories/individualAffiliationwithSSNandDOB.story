...
I can add affiliation with the individual provider based on SSN and DOB.
There is no advanced search for individual providers.


Scenario: Verifying that the system is showing SSN and DOB parameters based on the question in enrollment
Meta:
...
And fill Phone with value '(245)357-5678' on registration page
...
Scenario:Create Group Enrollment and Verify Enrollment approvals based on System Options Configuration:1 approver,2 reviewers to approve Group Enrollment
Meta:
...
|Pharma medi ltd      |123456           |7777          |1           |${date}   |
Then To fill the EFT Information:
...
When sign1 provider application for user titel & '${firstName} ${lastName}'
...
Examples:testdata/SDGroupAffiliation.table


Scenario: Verifying that the system is showing SSN and DOB parameters based on the question in provider datachange
Meta:
...
Scenario: Verifying that the system is showing SSN and DOB parameters based on the question in coc
Meta:
Given take firstname, lastname and email credentials for type 'Group1' and 'Approved' and use in session
Given user navigated to landing page
When new user logs to Provider Enrollment portal with username - ${email} and password - Aa123321!
...
Scenario: Verifying that the system is showing SSN and DOB parameters based on the question in re-enrollment
Meta:
