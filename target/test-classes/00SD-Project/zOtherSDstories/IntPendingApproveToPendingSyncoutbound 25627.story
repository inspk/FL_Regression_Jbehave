...
Narrative:
As the DYP IU,
I can change the status of Enrollment, Re-Enrollment, and Revalidation
from Pending approval to Pending Sync Approved,
so that system will pick the requests and send to SD system as per outbound process
...
And implicit wait '5' seconds
When click on 'Change status' button from the enrollment details page
When set to the status for enrollment request status - 'Pending Sync Approved' and set the '${date}' with reason - 'Approved Based Documents'
And implicit wait '5' seconds
!-- And refresh page
!-- And implicit wait '5' seconds
!-- And implicit wait '5' seconds
...
Then rewrite stage of credentials to 'PendingSyncApproved' for 'Individual1'
Examples:
