...
Narrative:
As the SD registered Enity provider,
I want to capture the home health service details
based on the program participation selected in service location
...
When implicit wait '2' seconds
And To fill the Service Location info:
|languageSupported|genderServed|ageRangesServed|officeLocation|
|English          |Male        |All ages served|Yes           |
When implicit wait '5' seconds
And To fill the Service Location info:
...
And To fill the Service Location info:
|billingServices|familyPlanning|esrdServices  |groupSpeciality|
|OP Rehab       |Immunizations |Hospital Based|Vision         |
And implicit wait '5' seconds
