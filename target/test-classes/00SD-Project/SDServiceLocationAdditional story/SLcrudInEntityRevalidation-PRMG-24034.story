...
Narrative:
As the approved Entity provider,
I can add / edit/remove/End the service location at the time of revalidation.
...
|Group1 |SOUTH DAKOTA CARES INC    |Clinic |10/11/1980|456-76-545111|2262618066|100 MAC LANE       |33110-4343       |11130                   |(245)357-5678|Interpreter     |171R00000X -  Interpreter|1864655944   |License    |California        |100 MAC LANE                      |33310-2345               |33140                           |Electronic Data Interchange EDI |19 Wyarno Rd, Sheridan WY           |Non-Profit 501(C)(3)  |3          |3456789098|Manager              |Managing Non Convicted |United States |0           |Alabama      |



Scenario: Revalidation (manually changed in db)
Meta:
Given take firstname, lastname and email credentials for type 'Group1' and 'Approved' and use in session
Given save value 'SOUTH DAKOTA CARES INC' to variable 'providerLegalBusinessName'
...
|Rural Health Clinic   |South Dakota|12345                   |${expDate}       |${date}             |
When implicit wait '5' seconds
