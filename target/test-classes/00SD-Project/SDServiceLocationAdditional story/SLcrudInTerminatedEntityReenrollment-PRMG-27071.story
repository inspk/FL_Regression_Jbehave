...
Narrative:
As the SD terminated Entity provider,
at the time of Re-enrolment
I want to Add/Edit/Remove/End the service location
based on conditions for the entity provider in a format that it meets the SD need.
...
And wait for screening process execution during '5' seconds
Then rewrite stage of credentials to 'Approved' for 'GroupTerminate1'
Examples:
...
When implicit wait '10' seconds
When log out from IU portal
Then rewrite stage of credentials to 'Terminated' for 'GroupTerminate1'

Scenario: Re-enrollment
Meta:
Given take firstname, lastname and email credentials for type 'GroupTerminate1' and 'Terminated' and use in session
Given user navigated to landing page
And save current date to variable 'date'
When save current date plus 1 years to variable 'expDate'
When new user logs to Provider Enrollment portal with username - ${email} and password - Aa123321!
...
And To fill the Program Participation section info:
|programParticipation|speciality|
|Medicaid/CHIP       |Clinics   |
And implicit wait '5' seconds
When click on 'Add Taxonomy' in Program participation section
And To fill the Program Participation section info:
|taxonomy                            |effectiveStartDate|effectiveEndDate|
|261QC1500X - Community Health Clinic|${date}           |${expDate}      |
When implicit wait '5' seconds
When click on 'Confirm' in Program participation section
When implicit wait '3' seconds
Then save the Program Participation
...
And To fill the Program Participation section info:
|taxonomy                        |effectiveStartDate|effectiveEndDate|
|261QR1300X - Rural Health Clinic|${date}           |${expDate}      |
When implicit wait '3' seconds
...
|Rural Health Clinic   |South Dakota|65432                   |${expDate}       |${date}             |
When implicit wait '5' seconds
...
And To fill the Program Participation section info:
|licenseCertificateType|issuer      |licenseCertificateNumber|effectiveEndDate2|effectiveStartDate2 |
|Rural Health Clinic   |South Dakota|45435                   |${expDate}       |${date}             |
When implicit wait '5' seconds
When upload document 'Upload License/Certificate Document*' document text_file.txt in Program Participation section
When implicit wait '15' seconds
When click on 'Add' in Program participation section
When implicit wait '5' seconds
When click on ' Edit' in Program participation section
And To fill the Program Participation section info:
...
When click on 'Add' in Program participation section
When implicit wait '5' seconds
When click on 'Delete' in Program participation section
When implicit wait '5' seconds
When click on 'Confirm' in Program participation section
When implicit wait '3' seconds
Then save the Program Participation
When implicit wait '3' seconds
Then Edit Program Participation for '261QR1300X - Rural Health Clinic'
When implicit wait '3' seconds
When click on 'Add Taxonomy' in Program participation section
And To fill the Program Participation section info:
|taxonomy                                      |effectiveStartDate|effectiveEndDate|
|261QF0400X - Federally Qualified Health Center|${date}           |${expDate}      |
When implicit wait '3' seconds
When click on 'Confirm' in Program participation section
When implicit wait '3' seconds
Then save the Program Participation
When implicit wait '3' seconds
Then Remove/End Program Participation for '261QR1300X - Rural Health Clinic'
When implicit wait '3' seconds
When move to 'Service Location' section
When implicit wait '5' seconds
When click on Add Location in Service Location section
