Meta:
Narrative:
As the SD approved Individual provider,
I can create a CoC for service location
to add, edit and delete the service location.
...
|${date}      |Secondary clinic|${primaryServiceLocationAddressLine1}|
When implicit wait '10' seconds
When click on 'Save' in Service Location section
And implicit wait '5' seconds
...
Examples:
|index      |gender|dob       |ssn          |fax        |ext |businessName |typeOfBusiness     |dbaName|claimSubmit                      |address                |attentionLine    |mailingAddressZip |mailingAddressCountycode|phoneno   |taxonomyCategory|primaryTaxonomy          |licenseNumber|licenseType|licenseIssuedState|primaryServiceLocationAddressLine1|primaryServiceLocationZip|primaryServiceLocationCountyCode|profitStatus|countryOfBirth|stateofBirth|stateOfBirth|reasonCode|managingEmployeeType |employeeStatus         |                          |
|Individual1|Male  |10/11/1980|456-76-545111|111-11-1111|222 |Clinic       |Individual Practice|Doctor |Electronic Data Interchange (EDI)|3001 HENDERSON DR      |Landmark         |2222-23433        |22222                   |3534534534|Interpreter     |171R00000X -  Interpreter|5764655900   |License    |California        |3001 HENDERSON DR                 |22110-2345               |22120                           |Non-Profit  |United States |0           |Alabama     |3         |Director             |Managing Non Convicted |
...
|Coc type|
|Program Participation / Taxonomy / License and Service location|
...
And To fill the Program Participation section info:
|programParticipation|speciality  |
|Medicaid/CHIP       |Physician   |
And implicit wait '5' seconds
When click on 'Add Taxonomy' in Program participation section
And To fill the Program Participation section info:
|taxonomy               |effectiveStartDate|effectiveEndDate|
|207VX0000X - Obstetrics|${date}           |${expDate}      |
When implicit wait '5' seconds
When click on 'Add License/Certificate' in Program participation section
And implicit wait '5' seconds
And To fill the Program Participation section info:
|licenseCertificateType|issuer      |licenseCertificateNumber|effectiveEndDate2|effectiveStartDate2 |
|DEA                   |South Dakota|56789                   |${expDate}       |${date}             |
When implicit wait '5' seconds
When upload document 'Upload License/Certificate Document*' document text_file.txt in Program Participation section
When implicit wait '15' seconds
When click on 'Add' in Program participation section
...
Then save the Program Participation
When implicit wait '3' seconds
Then Edit Program Participation for '207VX0000X - Obstetrics' in Coc page
When implicit wait '5' seconds
When click on 'Add Taxonomy' in Program participation section
And To fill the Program Participation section info:
|taxonomy                       |effectiveStartDate|effectiveEndDate|
|2085R0001X - Radiation Oncology|${date}           |${expDate}      |
And implicit wait '5' seconds
When click on 'Add License/Certificate' in Program participation section
And implicit wait '5' seconds
And To fill the Program Participation section info:
|licenseCertificateType|issuer      |licenseCertificateNumber|effectiveEndDate2|effectiveStartDate2 |
|DEA                   |South Dakota|76543                   |${expDate}       |${date}             |
When implicit wait '5' seconds
When upload document 'Upload License/Certificate Document*' document text_file.txt in Program Participation section
When implicit wait '15' seconds
When click on 'Add' in Program participation section
...
Then save the Program Participation
When implicit wait '3' seconds
Then Remove/End Program Participation for '2085R0001X - Radiation Oncology' in Coc page
When implicit wait '3' seconds
When move to 'Service Location' section
When implicit wait '5' seconds
Then Remove/End Secondary Service Location for 'Secondary clinic' with reason 'Changing the location' note 'Removal note' in COC page
When implicit wait '5' seconds
When click on Add Location in Service Location section
When implicit wait '5' seconds
And To fill the Service Location info:
|effectiveDate|locationName    |addressLine1|
|${date}      |Secondary Clinic|100 MAC LANE|
When implicit wait '10' seconds
When click on 'Save' in Service Location section
When implicit wait '5' seconds
Then Remove/End Primary Service Location for 'Primary Clinic' with reason 'Changing the location' note 'Removal note' in COC page
When implicit wait '5' seconds
Then click 'Yes' for the popup 'Deleting this location will result in data being deleted in affiliation as well. Do you desire to continue?'
When implicit wait '5' seconds
Then click 'Yes' for the popup 'Do you want to make one of the secondary service locations as Primary service location?'
When implicit wait '5' seconds
Then select secondary location 'Secondary Clinic' as primary location
When implicit wait '5' seconds
And To fill the Service Location info:
|locationName  |attentionLine|email   |phoneNumber  |
|Primary clinic|${firstName} |${email}|(231)232-1321|
When implicit wait '5' seconds
When click on 'Save' in Service Location section
When implicit wait '5' seconds
When move to new 'Summary' section
