...
@regression
Narrative:
1.I can Fill Group Enrollment application
...
|${providerName}          |${fein}                       |${email}|${dbaName}|No                 |No              |${profitStatus}|Yes       |5         |
When implicit wait '5' seconds
...
!-- |null                  |South Dakota|${expDate}       |${date}             |12345                   |
!-- When implicit wait '5' seconds
...
|${date}      |Primary clinic|${primaryServiceLocationAddressLine1}|${firstName} |${email}|${phone} |
When implicit wait '5' seconds
...
Examples:testdata/GroupProvidersForReviewersAndOfflinePayment.table
