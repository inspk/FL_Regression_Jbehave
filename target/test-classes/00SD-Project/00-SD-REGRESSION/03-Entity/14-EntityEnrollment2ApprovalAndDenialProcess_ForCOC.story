...
Meta:
Given take firstname, lastname and email credentials for type 'Group2' and 'ApprovedReviewCOC1' and use in session
...
Meta:
Given take firstname, lastname and email credentials for type 'Group2' and 'DeniedReviewCOC2' and use in session
Given user navigated to landing page
And save value 'Mediplus Community Service' to variable 'providerLegalBusinessName'
When new user logs to Internal User portal with username - internal.user.dyp+cd@gmail.com and password - Internaluser1!
When implicit wait '5' seconds
