...
Scenario: Individual Enrollment Reconsideration Flow
Meta:
Given take firstname, lastname and email credentials for type 'Individual1' and 'Denied' and use in session
...
Then rewrite stage of credentials to 'CreatedAppeal' for 'Individual1'
...
Meta:
Given take firstname, lastname and email credentials for type 'Individual1' and 'CreatedAppeal' and use in session
Given user navigated to landing page
