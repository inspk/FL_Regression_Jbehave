...
Meta:
Given take firstname, lastname and email credentials for type 'Individual2' and 'ApprovedReviewCOC1' and use in session
...
Meta:
Given take firstname, lastname and email credentials for type 'Individual2' and 'DeniedReviewCOC2' and use in session
Given user navigated to landing page
When new user logs to Internal User portal with username - internal.user.dyp+cd@gmail.com and password - Internaluser1!
And implicit wait '5' seconds
When click on new 'Agree' button in the Portal page
