...
Narrative:
As the DyP system,
system will check for the duplicate NPI at the time of enrollment
and system should not allow for the duplicate NPI
...
Given get random npi from file 'WyNPI'
Given set duplicate npi '${npi}'
!-- And save value '1851724025' to variable 'npi'
...
Scenario:System should not allow for the duplicate NPI at the time of enrollment
Meta:
Given generate firstname, lastname and email credentials for '<index>'
Given get random npi from file 'WyNPI'
Given get duplicate npi
!-- And save value '1851724025' to variable 'duplicateNpi'
And save value '<provider>' to variable 'provider'
And save value '<gender>' to variable 'gender'
And save value '<dob>' to variable 'dob'
And save value '<ssn>' to variable 'ssn'
...
And implicit wait '5' seconds
And implicit wait '5' seconds
Then verify duplicate npi message for '${duplicateNpi}'
When implicit wait '5' seconds
And To fill the Provider Identification Number:
|npi      |
|${npi}   |
...
Scenario:System should not allow for the duplicate NPI at the time of coc
Meta:
...
Scenario:System should not allow for the duplicate NPI at the time of re-enrollment
Meta:
