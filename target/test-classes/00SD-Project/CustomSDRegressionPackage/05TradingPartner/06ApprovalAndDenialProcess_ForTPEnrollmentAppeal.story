...
Scenario:Verify Appeal approvals based on System Options Configuration:1 approver,2 reviewers to approve Appeal Tp Enrollment
Meta:
...
When new user logs to Internal User portal with username - wy.internalusers+lewis.wood@gmail.com and password - Internaluser1!
And implicit wait '5' seconds
When click on new 'Agree' button in the Portal page
And implicit wait '5' seconds
And click on Reconsideration tab on header
...
When log out from IU portal
When user navigated to landing page
When new user logs to Internal User portal with username - internalusers+leonard.peterson@gmail.com and password - Internaluser1!
And implicit wait '5' seconds
When click on new 'Agree' button in the Portal page
And implicit wait '5' seconds
And click on Reconsideration tab on header
...
Then rewrite stage of credentials to 'Appeal' for 'TradingPartner2'

Scenario:Verify Appeal approvals based on System Options Configuration:1 approver,2 reviewers to Deny Appeal TP Enrollment
Meta:
...
And wait for screening process execution during '5' seconds
Then rewrite stage of credentials to 'Appeal' for 'TradingPartner3'
