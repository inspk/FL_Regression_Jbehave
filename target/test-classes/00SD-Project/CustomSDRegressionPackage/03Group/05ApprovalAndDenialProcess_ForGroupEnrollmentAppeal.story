...
Meta:
Given take firstname, lastname and email credentials for type 'Group2' and 'Denied' and use in session
...
|Documents update|William  |Faulkner|
...
When implicit wait '5' seconds
Then rewrite stage of credentials to 'CreatedAppeal' for 'Group2'

Scenario:Verify Appeal approvals based on System Options Configuration:1 approver,2 reviewers to Deny Appeal Group Enrollment
Meta:
...
Then success message with text - Success!Your request was submitted. should be displayed
When implicit wait '5' seconds
Then rewrite stage of credentials to 'CreatedAppeal' for 'Group3'