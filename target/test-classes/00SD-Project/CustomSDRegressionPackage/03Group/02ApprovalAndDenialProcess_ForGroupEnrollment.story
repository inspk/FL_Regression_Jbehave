...
Scenario:Verify Enrollment approvals based on System Options Configuration:1 approver,2 reviewers to Deny Individual Enrollment
Meta:
Given take firstname, lastname and email credentials for type 'Group2' and 'Created' and use in session
And save value 'ODA Internal Medicine' to variable 'providerLegalBusinessName'
Given user navigated to landing page
When new user logs to Internal User portal with username - wy.internalusers+frank.walker@gmail.com and password - Aa123321!
And implicit wait '5' seconds
When click on new 'Agree' button in the Portal page
