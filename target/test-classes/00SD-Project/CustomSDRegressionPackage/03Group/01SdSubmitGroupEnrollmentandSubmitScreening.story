...
When user navigated to landing page
When new user logs to Provider Enrollment portal with username - nagure.providers+7971@gmail.com and password - Aa123321!
And implicit wait '5' seconds
When click on new 'Agree' button in the Portal page
And implicit wait '5' seconds
...
Examples:testdata/CustomSDGroupProvidersForcustomregression.table
