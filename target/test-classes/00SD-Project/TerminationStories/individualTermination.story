...
Narrative:
As the terminated DYP individual provider,
I need to fill the requested enrollment date in re-enrollment.
...
Scenario:Reactive and Terminate the Individual Provider
Meta:
...
Scenario: I need to fill the requested enrollment date in re-enrollment
Meta:
Given take firstname, lastname and email credentials for type 'Individual5' and 'Approved' and use in session
Given user navigated to landing page
When new user logs to Provider Enrollment portal with username - ${email} and password - Aa123321!
