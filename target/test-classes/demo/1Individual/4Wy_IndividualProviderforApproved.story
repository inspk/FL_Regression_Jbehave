...
And fill Validate password with value 'Aa123321!' on registration page
...
When implicit wait '2' seconds
When user logs to Provider Enrollment portal with username - ${email1} and password - Aa123321!
...
Examples:testdata/demoTestData/IndividualinApproved.table
