...
Scenario: Approvals Reviewers Configuration in Enrollment,COC and Revalidation for MCO Providers
Meta:
...
When expand the Managed Care Organisation Approval configuration for 'Managed Care Organisation' Enrollment type Page
When implicit wait '5' seconds
