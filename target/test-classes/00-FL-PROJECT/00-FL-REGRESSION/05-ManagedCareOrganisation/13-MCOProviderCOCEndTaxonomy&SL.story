...
Scenario:MCO Provider end Taxonomy and SL COC flow to Approve
Meta:
...
Then Remove/End taxonomy for '284300000X'
...
Scenario:Verify COC approvals based on System Options Configuration:1 approver,2 reviewers to approve End Taxonomy & SL COC
Meta:
Given take firstname, lastname and email credentials for type 'MCO3' and 'Approved' and use in session
Given user navigated to landing page
