...
Scenario:Verify COC approvals based on System Options Configuration:1 approver,2 reviewers to approve COC for MCO Enrollment
Meta:
Given take firstname, lastname and email credentials for type 'MCO3' and 'ApprovedReviewCOC1' and use in session
...
Scenario:Verify COC approvals based on System Options Configuration:1 approver,2 reviewers to deny COC for MCO Enrollment
Meta:
Given take firstname, lastname and email credentials for type 'MCO3' and 'DeniedReviewCOC2' and use in session
Given user navigated to landing page
And save value 'Mediplus Community Services' to variable 'planLegalName'
When new user logs to Internal User portal with username - internal.user.dyp+cd@gmail.com and password - Internaluser1!
And implicit wait '5' seconds
...
When implicit wait '5' seconds
When click to provider data with text '${planLegalNam}' on IU portal
And implicit wait '30' seconds
When click on 'Change status' button from the enrollment details page
When implicit wait '5' seconds
When set enrollment request Under Clearing House Check status to - 'Clearing House Check Completed'
