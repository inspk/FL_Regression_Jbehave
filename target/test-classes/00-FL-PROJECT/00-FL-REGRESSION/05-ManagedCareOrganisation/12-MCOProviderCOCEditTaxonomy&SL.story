...
Scenario:MCO Provider edit Taxonomy and SL COC flow to Approve
Meta:
...
Then Edit taxonomy for '284300000X'
...
Scenario:Verify COC approvals based on System Options Configuration:1 approver,2 reviewers to approve Edit Taxonomy & SL COC
Meta:
Given take firstname, lastname and email credentials for type 'MCO3' and 'Approved' and use in session
Given user navigated to landing page
