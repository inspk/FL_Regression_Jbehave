...
Scenario: Verify Florida Medicaid ID for PEM Enrollment
Meta:
...
When implicit wait '10' seconds
When expand the Group Providers Approval configuration for 'Provider Enrollment Manager' Enrollment type Page
When implicit wait '10' seconds
