...
Scenario: Verify Florida Medicaid ID for Individual Enrollment
Meta:
...
When implicit wait '5' seconds
When expand the Group Providers Approval configuration for 'Individual Provider' Enrollment type Page
When implicit wait '5' seconds
