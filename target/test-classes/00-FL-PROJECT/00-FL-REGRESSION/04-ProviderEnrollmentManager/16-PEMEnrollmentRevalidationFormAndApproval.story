...
Scenario: Create Revalidation For PEM Enrollment for 1 month
Meta:
...
And implicit wait '5' seconds
When set providerid search value '4000218' in affiliation section
And implicit wait '5' seconds
...
And implicit wait '10' seconds
When set providerid search value '4000011' in affiliation section
...
When implicit wait '5' seconds
Then End Affiliation for 'PEM to  TP'
...
When new user logs to Provider Enrollment portal with username - dyp.provider+ds@gmail.com and password - Aa123321!
When click on new 'Agree' button in the Portal page
When skip help tour if exists
...
Scenario:PEM Provider Status Changing from New to Approved with 2 reviewers and 1 Approver
Given take firstname, lastname and email credentials for type 'ProviderEnrollmentManager1' and 'Approved' and use in session
Given user navigated to landing page
And save current date to variable 'date'
When new user logs to Internal User portal with username - internal.user.dyp+cd@gmail.com and password - Internaluser1!
