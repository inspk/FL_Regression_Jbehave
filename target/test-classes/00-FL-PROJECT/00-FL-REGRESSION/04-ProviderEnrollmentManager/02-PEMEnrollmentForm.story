...
Meta:
Given generate firstname, lastname, middlename and email credentials for 'ProviderEnrollmentManager1'
...
|${firstName}|${lastName}|${gender}|${email} |3534534534 |${countryOfBirth}|{stateOfBirth}|${dob}     |${ssn} |
When implicit wait '5' seconds
...
And implicit wait '5' seconds
When set providerid search value '4000026' in affiliation section
...
And implicit wait '3' seconds
When set providerid search value '4000001' in affiliation section
...
Then End Affiliation for 'PEM to INDIVIDUAL'
When implicit wait '5' seconds
