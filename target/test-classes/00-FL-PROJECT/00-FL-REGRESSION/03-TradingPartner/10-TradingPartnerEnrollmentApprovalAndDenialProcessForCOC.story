...
Meta:
Given take firstname, lastname and email credentials for type 'TradingPartner3' and 'ApprovedReviewCOC1' and use in session
Given user navigated to landing page
And save value 'CORUS AT HOME LMT' to variable 'businessName'
...
Meta:
Given take firstname, lastname and email credentials for type 'TradingPartner3' and 'DeniedReviewCOC2' and use in session
Given user navigated to landing page
And save value 'CORUS AT HOME LMT' to variable 'businessName'
When new user logs to Internal User portal with username - internal.user.dyp+cd@gmail.com and password - Internaluser1!
And implicit wait '5' seconds
