...
Meta:
Given generate firstname, lastname, middlename and email credentials for 'Individual4'
...
When implicit wait '5' seconds
Then rewrite stage of credentials to 'Submitted' for 'Individual4'
...
Given take firstname, lastname and email credentials for type 'Individual4' and 'Submitted' and use in session
...
When implicit wait '5' seconds
Then rewrite stage of credentials to 'Approved' for 'Individual4'
