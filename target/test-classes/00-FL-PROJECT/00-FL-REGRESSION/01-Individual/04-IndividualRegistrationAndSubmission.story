...
And To fill the identifying information section for Enrollment:
|firstName   |lastName   |dateOfBirth|appliationContactName   |applicationContactNum|ssn    |email    |middleName   |taxExempt |businessName   |dbaName   |
|${firstName}|${lastName}|${dob}     |${firstName} ${lastName}|${phoneno}           |${ssn} |${email} |${middleName}|Yes       |${businessName}|${dbaName}|
...
!-- And implicit wait '5' seconds
!-- When set npi search value '1699444315' in affiliation section
!-- And implicit wait '5' seconds
...
|managingEmployeeType    |employeeStatus   |npi   |race   |gender   |firstName    |middleName    |lastName   |ssn    |dob     |countryOfBirth   |stateOfBirth    |ssnStartDate |ssnEndDate |ssnAddress |
|ADMINISTRATOR           |${employeeStatus}|${npi}|${race}|${gender}|${firstName} |${middleName} |${lastName}|${ssn} |${dob}  |${countryOfBirth}|${stateOfBirth} |${date}      |${expDate} |${address} |
When implicit wait '5' seconds
