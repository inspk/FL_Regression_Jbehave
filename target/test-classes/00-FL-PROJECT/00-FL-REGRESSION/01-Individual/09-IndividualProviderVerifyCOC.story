...
When implicit wait '5' seconds
Then rewrite stage of credentials to 'DeniedReviewCOC2' for 'Individual3'
...
|financialInstitution    |EFTRoutingNumber |startDate |
|Pharma Mediplus Pvt Lmt |9876524366       |${date}   |
When implicit wait '5' seconds
