...
Scenario:Individual Provider End Affiliation COC flow to Approve
Meta:
...
And implicit wait '5' seconds
Then click on ellipsis and End Affiliation for 'INDIVIDUAL to ENTITY' with reason 'Incorrectly Linked'
...
Scenario:Verify COC approvals based on System Options Configuration:1 approver,2 reviewers to approve End Affiliation COC
Meta:
Given take firstname, lastname and email credentials for type 'Individual1' and 'Approved' and use in session
Given user navigated to landing page
...
When implicit wait '5' seconds
Then verify Provider Name '${providerLegalBusinessName}' and Affiliation Type 'INDIVIDUAL to ENTITY' in Affiliation Tab
When implicit wait '5' seconds
When implicit wait '5' seconds
When log out from IU portal
And implicit wait '5' seconds
